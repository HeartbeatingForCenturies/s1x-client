...
namespace virtuallobby
{
	namespace
	{
		static game::dvar_t* virtualLobby_fov;
		static game::dvar_t* virtualLobby_fovscale;
		...
		void* get_fovscale_stub()
		{
			return utils::hook::assemble([](utils::hook::assembler& a)
			{
				...
				a.bind(ret);
				a.lea(rcx, ptr(reinterpret_cast<int64_t>(*reinterpret_cast<void**>(0x1414C1700))));
				a.jmp(0x1401D5CB8);
			});
		}
	}
